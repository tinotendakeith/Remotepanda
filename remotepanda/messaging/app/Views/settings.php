                    ...
                    <div class="col-md-12 grid-margin">
                        <div class="d-flex justify-content-between flex-wrap">
                            <div class="d-flex align-items-end flex-wrap">
                                ...
                                <div class="d-flex">
                                    <i class="mdi mdi-settings text-muted hover-cursor"></i>
                    ...
                    <div class="col-md-12 grid-margin stretch-card">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <?php echo form_open("settings", ["class"=>"mt-5"]) ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <?php echo form_input("test-number", $testNumber ?? "", ["class"=>"form-control", "placeholder"=>"Number to send messages", "required"=>"required"], "tel") ?>
                                    <small class="d-block text-secondary mt-1">When system is disabled all messages are sent to this number</small>
                                </div>
                                    <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <?php echo form_input("site-name", $siteName ?? "", ["class"=>"form-control", "required"=>"required", "placeholder"=>"Name of site"]) ?>
                                </div>
                            ...
                            <div class="card-body">
                                ...
                                <?php echo form_open("settings", ["class"=>"mt-5"]) ?>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <?php echo form_input("twilio-from", $twilio_from ?? "", ["class"=>"form-control", "placeholder"=>"A Twilio phone number you purchased at twilio.com/console", "required"=>"required"], "tel") ?>
                                        <small class="text-secondary">Modifies value set in <code>.env</code> file</small>
                                    </div>
                            ...
                            <div class="card-body">
                                ...
                                <?php echo form_open("settings", ["class"=>"mt-5"]) ?>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <?php echo form_input("test-number", "", ["class"=>"form-control", "placeholder"=>"Test number to send test message", "required"=>"required"], "tel") ?>
                                    </div>

                                    <label>Method for sending message</label>
                                    <div class="form-check form-check-flat form-check-primary">
                                        <label class="form-check-label">
                                            <?php echo form_radio("test-method", "whatsapp", true, ["class"=>"form-control", "required"=>"required"]) ?>
                                            Whatsapp
                                        </label>
                                    </div>
                                    <div class="form-check form-check-flat form-check-primary">
                                        <label class="form-check-label">
                                            <?php echo form_radio("test-method", "message", false, ["class"=>"form-control", "required"=>"required"]) ?>
                                            Message
                                        </label>
                                    </div>

                                    <button type="submit" class="btn btn-primary me-2" name="test">Send Test Message</button>
                                <?php echo form_close() ?>
                            </div>
                        </div>
                    </div>
