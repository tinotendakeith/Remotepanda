...
if(isset($_POST['submit']))
  {
   ...
   $query=mysqli_query($con, "UPDATE `study` SET `status`='scanned' WHERE `study`. `study_id`='$cid'");
					...
					<div class="table-responsive bs-example widget-shadow">
                        ...
                        <table class="table table-bordered">
                                            ...
                                            <th style="width: 26%;">Name</th>
                                               ...
                                               <tr>
                                                <th>Scan Type</th>
                                                <td><?php  echo $row['requested_procedure'];?></td>
                                              </tr>
                                            ...
                                            <tr>
                                              ...
                                              <tr>
                                                <th>Remarks</th>
                                                <td><textarea  name="textspace" id="textarea" class="tinymce" cols="90" rows="10"><?php echo $row['textarea']; ?></textarea></td>
                                              </tr>
                                              ...
                                              <tr>
                                                ...
                                                <td>
                                                    ...
                                                    $cid=$_GET['viewid'];
                                                    $select = "SELECT * FROM `study` where study_id='$cid'";
                                                                                $cnt=1;
                                                    ...
                                                    ?>
                                                 <iframe src="<?php echo "pdf/$pdf"; ?>" width="90%" height="500px"> </iframe>   
                                                </td>
                                              </tr>
                                                  ...
                                                  <tr align="center">
                                                <td colspan="2">
                                                    <button type="submit" name="submit" class="btn btn-az-primary pd-x-20">Back to Home</button>
                                                </td>
