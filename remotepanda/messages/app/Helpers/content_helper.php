 ...
 * @author  Richard Muvirimi <rich4rdmuvirimi@gmail.com>
 */
function delete_content(string $type, int $id = DEFAULT_ID, int $user = DEFAULT_ID, int $parent = DEFAULT_PARENT_ID): bool
{
    if (empty($type)) {
        throw new DataException('Type field is required');
    }
 ...
 * @author  Richard Muvirimi <rich4rdmuvirimi@gmail.com>
 */
function delete_content_meta(int $content, string $key, $value = '', int $metaId = DEFAULT_ID): bool
{
    if (empty($content) || empty($key)) {
        throw new DataException('Key and content field is required');
    }
 ...
 *
 * @return  Content|array|false|object
 * @since   1.0.0
 * @version 1.0.0
 *
 * @author Richard Muvirimi <rich4rdmuvirimi@gmail.com>
 ...
 * @author  Richard Muvirimi <rich4rdmuvirimi@gmail.com>
 */
function get_user_content(string $type, int $user = DEFAULT_ID, int $parent = DEFAULT_PARENT_ID, int $limit = 0): array
{
