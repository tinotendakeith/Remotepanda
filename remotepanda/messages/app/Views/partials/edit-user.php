    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <?php endif; ?>
                <?php echo form_open("users", ["id" => "manageUSerForm", "method" => "GET"]) ?>
                <?php echo form_hidden("user-id", DEFAULT_ID) ?>
                <div class="form-group">
                    <label for="user-name">User Name</label>
                    <?php echo form_input("user-name", "", ["class" => "form-control", "placeholder" => "Name of user", "required" => "required", "autocomplete" => "name"]) ?>
                </div>
                <div class="form-group">
                    <label for="user-name">User Login</label>
                    <?php echo form_input("user-login", "", ["class" => "form-control", "placeholder" => "Alternative login identifier of user", "required" => "required", "autocomplete" => "username"]) ?>
                </div>
                <div class="form-group">
                    <label for="user-name">User Email</label>
                    <?php echo form_input("user-email", "", ["class" => "form-control", "placeholder" => "Email of user", "required" => "required", "autocomplete" => "email"], "email") ?>
            ...
            <div class="modal-footer">
                <button type="submit" form="manageUSerForm" name="submit" class="btn btn-primary btn-send-message">
                    Save
                </button>
