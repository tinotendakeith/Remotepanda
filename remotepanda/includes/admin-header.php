      ...
      <div class="header-right">
        ...
        <!--<meta http-equiv="refresh" content="50">-->
          ...
          <ul class="nofitications-dropdown">
            <?php $ret1=mysqli_query($con,"select *from tickets where status='Open'"); $num=mysqli_num_rows($ret1);
              ...
              <ul class="dropdown-menu">
                <li>
                  <div class="notification_header">
                    <h3>You have <?php echo $num;?>Open Tickets </h3>
                  </div>
                </li>
                <li>
                ...
                while($result=mysqli_fetch_array($ret1))
                     {  ?>
                      <a class="dropdown-item" href="view-ticket.php?viewid=<?php echo $result['ticket_number'];?>">
                      <span style ="background:#01152a; color:#fff; width:128%; display:block; padding: 2px 10px 2px 20px !important; margin: 0px !important; margin-bottom: 5px !important; border-radius:20px " >
                        <?php echo $result['Name'];?></span> </a><?php }} else {?>
                      <a class="dropdown-item" href="remarks.php">No Open Tickets</a>
                 <?php } ?>
                 ...
                 <li>
                  <div class="notification_bottom">
                    <a href="remarks.php">See all Tickets</a>
                  </div> 
                </li>
              </ul>
            </li> 
